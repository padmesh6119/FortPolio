...
(function(){
  const PROJECTS=[
    ...
    {id:13,name:'arise',icon:'ti-sword',domain:'Gamification · Web App',cat:'indev',stack:['Next.js','TypeScript','Supabase','Framer Motion'],status:'IN DEV',desc:'Solo Leveling-style habit RPG. Daily quests feed five stats, streaks multiply XP, trial quests gate rank-ups from E to Monarch. Hunter License card generated server-side from live data.',size:'19.2 KB',modified:'2026-04-30',link:null},
    ...
    {id:15,name:'iot-chaincode',icon:'ti-topology-star',domain:'Blockchain · IoT',cat:'hardware',stack:['Go','Hyperledger Fabric'],status:'ACTIVE',desc:'Hyperledger Fabric chaincode for IoT device identity management. DID-based device registration, trust scoring, firmware hash verification, and permission management on a permissioned blockchain.',size:'11.6 KB',modified:'2026-02-20',link:null},
