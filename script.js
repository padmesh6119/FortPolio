...
(function(){
  const PROJECTS=[
    ...
    {id:5,name:'wind0c',icon:'ti-brand-windows',domain:'Systems · Optimisation',cat:'tools',stack:['PowerShell','Windows'],status:'ACTIVE',desc:'Telemetry removed. Bloatware purged. Cortana gone. One script.',size:'3.8 KB',modified:'2024-11-08',link:'https://github.com/padmesh6119/Wind0c'},
    {id:7,name:'nfc-auth-desk',icon:'ti-device-mobile',domain:'Hardware · Auth',cat:'hardware',stack:['ESP32','NFC','Node'],status:'IN DEV',desc:'Desktop NFC authentication bridge. Tap your card, unlock your session.',size:'11.2 KB',modified:'2024-10-30',link:null},
    ...
    {id:9,name:'maliketh',icon:'ti-key',domain:'Password Manager · Auth',cat:'auth',stack:['Python','Argon2id','XChaCha20-Poly1305'],status:'ACTIVE',desc:'Local-first password vault with browser autofill. Secrets sealed with XChaCha20-Poly1305 under Argon2id-derived keys. Decrypted key lives only inside a persistent agent process — never on disk, never in the browser. Origin-scoped autofill: credentials only surface on the exact domain they belong to.',size:'14.3 KB',modified:'2026-07-20',link:'https://github.com/padmesh6119/Maliketh'},
    {id:10,name:'rook',icon:'ti-microphone',domain:'AI · Voice Assistant',cat:'tools',stack:['Python','LiveKit','MCP','WhatsApp'],status:'ACTIVE',desc:'Personal AI voice assistant. Three cooperative processes: a LiveKit voice agent, an MCP tools server, and a WhatsApp bridge. Optional PyQt6 HUD overlay. One launcher script spins everything up.',size:'22.1 KB',modified:'2026-07-25',link:null},
    {id:11,name:'aeids',icon:'ti-brain',domain:'ML · Intrusion Detection',cat:'security',stack:['Python','XGBoost','SHAP','RL'],status:'ACTIVE',desc:'Adaptive Explainable IDS. Classifies network flows with XGBoost, explains every decision with SHAP values, and uses a reinforcement-learning agent to decide autonomously when to retrain on concept drift. Phase 2: drift detection and RL retraining policy.',size:'31.4 KB',modified:'2026-06-10',link:null},
    {id:12,name:'nids',icon:'ti-radar',domain:'Network Security · IDS/IPS',cat:'security',stack:['Python','JA3','IsolationForest','nftables'],status:'ACTIVE',desc:'Seven-engine hybrid NIDS/IPS. Signature heuristics, JA3 TLS fingerprinting, threat-intel IOC matching, IsolationForest anomaly detection, autoencoder reconstruction scoring, RITA-style C2 beacon detection, and live nftables auto-blocking. Live websocket SOC dashboard. Suricata EVE JSON output.',size:'28.7 KB',modified:'2026-05-18',link:'https://github.com/padmesh6119/MLBIDS'},
    ...
    {id:19,name:'nfc-puf',icon:'ti-nfc',domain:'Hardware · Auth',cat:'hardware',stack:['ESP32','NFC','PUF'],status:'ACTIVE',desc:'NFC-triggered physically unclonable function based hardware-level device authentication on ESP32. Each device produces a unique fingerprint derived from silicon manufacturing variance.',size:'6.8 KB',modified:'2024-08-20',link:'https://github.com/padmesh6119/NFC-Conditioned-PUF-Authentication-System'},
